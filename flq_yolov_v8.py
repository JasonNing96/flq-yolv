...
# -*- coding: utf-8 -*-
"""
FLQ-YOLOv8 联邦训练脚本 (v8: FreezeBN Version)
----------------------------------------------------------------
- 核心改进: 冻结 BatchNorm 层的统计量 (Freeze BN Statistics)
- 解决痛点: 解决 FL 中因数据 Non-IID 导致的 BN 统计量偏移 (BN Drift) 问题
- 适用场景: 预训练模型微调 (Transfer Learning), 小数据/联邦场景
- 继承功能: DIL 模拟, CSV 记录, Stateless 训练, Global LR Aggregation
----------------------------------------------------------------
"""
